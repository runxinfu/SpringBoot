package com.uton.admin.common.util;

import com.uton.admin.common.annotation.ExportConfig;
import com.uton.admin.common.handler.ExportHandler;
import com.uton.admin.common.util.poi.convert.ExportConvert;
import com.uton.admin.common.util.poi.pojo.ExportItem;
...
public class ExcelUtils {
    ...
    private void requiredbuilderParams() {
        if (mClass == null) {
            throw new IllegalArgumentException("请先使用com.uton.admin.util.ExcelUtils.builder(Class<?>)构造器初始化参数。");
        }
    }
    ...
    private void requiredexportParams() {
        if (mClass == null || mResponse == null) {
            throw new IllegalArgumentException(
                    "请先使用com.uton.admin.util.ExcelUtils.export(Class<?>, HttpServletResponse)构造器初始化参数。");
        }
